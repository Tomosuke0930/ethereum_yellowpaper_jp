...
我々は、イーサリアムのプロトコルを紹介し、議論し、正式に定義した。このプロトコルにより、読者はイーサリアムネットワーク上のノードを実装し、分散型の安全な社会的オペレーティングシステムに他の人と参加することができます。

契約は、相互作用のルールをアルゴリズムで指定し、自律的に強制するために作成されるかもしれません
