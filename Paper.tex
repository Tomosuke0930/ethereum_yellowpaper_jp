...
Homesteadのリビジョンを作成したAeron Buchanan、Ethashのアルゴリズムを作成したChristoph Jentzsch、EIP-150のほとんどの変更を行ったYoichi Hiraiに感謝を表します。
EIP-150の変更のほとんどを行ったYoichi Hiraiです。Gustav Simonsson、Pawe l Bylica、Jutta Steiner、Nick Savers、Viktor Tr´on、Marko Simovic、Giacomo Tazzari、そしてもちろんVitalik Buterinを含むEthereum DEVの組織やEthereumコミュニティ全体から重要なメンテナンス、役に立つ修正、提案が多数提供されました。
